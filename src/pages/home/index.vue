<template>
  <div class="page-home">
    <div class="top-image">
      ...
      <div class="context slef-intro">
        <div class="context-content">
          <h1 class="h1-title">Hello Joeyzone</h1>
          <p class="h2-title">Self introduction:</p>
          <p class="n-text">10 years of frontend engineering</p>
          <p class="n-text">
      ...
      <div class="context pro-desc">
        <div class="context-content">
          ...
          <a
            class="link"
            href="https://github.com/joeyzone/JYZ-DAO"
            target="_blank"
            rel="noopener noreferrer"
